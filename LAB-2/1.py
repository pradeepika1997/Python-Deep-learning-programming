...
history = Model.fit(x_train, y_train, batch_size=256, epochs=25, shuffle=True, verbose=0, validation_data=(x_valid, y_valid), callbacks=[keras.callbacks.TensorBoard(log_dir="./4  ", histogram_freq=1, write_graph=True, write_images=True)])
